...
public class Inventario {
    public static void main(String[] args) {
        ...
        String cancion1=new String ("Hola");
        String cancion2=new String ("Adios");
        String cancion3 = new String("Nombre1");
       
        nombreCanciones.add(cancion1);
        nombreCanciones.add(cancion2);
        nombreCanciones.remove("nombre2");
       // String[] canciones1 = {"hola","adios"};
        Musica disco1 = new Musica(nombreCanciones, "Michael Jackson", 9, 1500, 123456789, "Thriller", "MJJ Productions Inc");
